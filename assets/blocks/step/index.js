...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"gutenform/step","version":"0.1.0","title":"Step","category":"widgets","icon":"editor-ol","description":"Step container block for multi-step forms in Gutenform.","parent":["gutenform/form"],"example":{},"attributes":{"title":{"type":"string","default":"Step"},"stepId":{"type":"string","default":""},"conditionalShow":{"type":"object","default":null}},"usesContext":["gutenform/activeStep"],"supports":{"html":false,"spacing":{"padding":true,"blockGap":true},"color":{"background":true,"text":true},"border":{"color":true,"radius":true,"width":true},"layout":{"allowSwitching":false,"allowInheriting":false,"default":{"type":"default","orientation":"vertical"}}},"textdomain":"gutenform","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/* harmony import */ var _components_block_atoms_ConditionalLogicControls__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../components/block-atoms/ConditionalLogicControls */ "./src/components/block-atoms/ConditionalLogicControls/index.tsx");
/* harmony import */ var _allowedBlocks__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./allowedBlocks */ "./src/blocks/step/allowedBlocks.ts");
/* harmony import */ var _lib_use_unique_id__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../lib/use-unique-id */ "./src/lib/use-unique-id.ts");
/* harmony import */ var _editor_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./editor.css */ "./src/blocks/step/editor.css");
...
function Edit(props) {
  ...
  (0,_lib_use_unique_id__WEBPACK_IMPORTED_MODULE_7__.useUniqueID)(attributes.stepId, clientId, attrs => setAttributes({
    stepId: attrs.id
  }), 'gutenform-step');
  ...
  const innerBlockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useInnerBlocksProps)({}, {
    allowedBlocks: _allowedBlocks__WEBPACK_IMPORTED_MODULE_6__.allowedBlocks,
    prioritizedInserterBlocks: _allowedBlocks__WEBPACK_IMPORTED_MODULE_6__.prioritizedInserterBlocks,
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Fragment, {
    ...
    }), clientId && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_components_block_atoms_ConditionalLogicControls__WEBPACK_IMPORTED_MODULE_5__.ConditionalLogicControls, {
      clientId: clientId,
...
/* harmony import */ var _blockTypes_conditionalLogic__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/blockTypes/conditionalLogic */ "./src/blockTypes/conditionalLogic.ts");
...
function save(props) {
  ...
  const blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.useBlockProps.save({
    ...
    ...((0,_blockTypes_conditionalLogic__WEBPACK_IMPORTED_MODULE_1__.hasConditionalShowToOutput)(conditionalShow) && {
