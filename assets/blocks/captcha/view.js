...
window.addEventListener('DOMContentLoaded', () => {
  ...
  captchaBlocks.forEach(block => {
    ...
    const container = block.querySelector('.gutenform-captcha-container');
    if (!container) return;
...
function initFriendlyCaptcha(container, siteKey) {
...
function initRecaptcha(container, siteKey) {
